#!/usr/bin/env python
"""
Demo script to run the DVC pipeline with MLflow tracking and DAGsHub integration.
"""
import os
import subprocess
import argparse
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run DVC and MLflow demo")
    ...
    if args.setup_only:
        print("Setup completed. Use 'python run_demo.py' to run the pipeline.")
        return
